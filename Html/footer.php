        ...
        <div class="footer-container">
            ...
            <div class="footer-column">
                ...
                <ul class="footer-list">
                    ...
                    <li><a href="pages/vehicles.html">Vehicles</a></li>
            ...
            <div class="footer-column">
                <h3 class="footer-title">Get Updates</h3>
                <p class="footer-text">Subscribe for new arrivals, price drops, and expert tips.</p>
                <form class="footer-form">
                    <input type="email" placeholder="Email address" aria-label="Email address" required>
                    <button type="submit">Subscribe</button>
                </form>
                <p class="footer-note">By subscribing, you agree to our Privacy Policy.</p>
            </div>
        </div>

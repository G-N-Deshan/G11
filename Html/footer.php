        ...
        <div class="footer-container">
            ...
            <div class="footer-column">
                ...
                <ul class="footer-list">
                    <li><a href="/G11/Html/pages/about.php">About</a></li>
                    <li><a href="/G11/Html/pages/reviews.php">Reviews</a></li>
                    <li><a href="/G11/Html/pages/buy.php">BUY</a></li>
                    <li><a href="/G11/Html/pages/contact.php">Contact</a></li>
                </ul>
            </div>
